...
/**
 * Generated class for the FlashcardTestPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-flashcard-test',
  templateUrl: 'flashcard-test.html',
})
export class FlashcardTestPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FlashcardTestPage');
  }
